...
const ContactItem = (props) => {
    return(
        <div id={props.id} className="container ContactItem">
            <div className='row ps-4 pe-4 pb-3 pt-3'>
                <div style={{backgroundImage: `url(https://randomuser.me/api/portraits/${props.gender}/${props.avatar}.jpg)`}} className='col-3 avatar me-4'></div>
                <div className='col-9'>
                <div className='tag bg_blue mb-4'>{props.status}</div>
